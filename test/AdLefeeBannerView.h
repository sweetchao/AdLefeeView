...
/*
 ...
 自动轮换
 */
-(instancetype)initWithFrame:(CGRect)frame Withadid:(NSString *)adid adType:(AdLefeeAdType)type adLefeeViewDelegate:(id<AdLefeeBannerViewDelegate>)delegate adLefeeBroswerDelegate:(id<AdLefeeBrowserDelegate>)broswerDelegate;
// 广告居中
