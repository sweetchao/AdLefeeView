...
- (instancetype)initWithBannerView:(AdLefeeBannerView *)view withAdid:(NSString *)adid adType:(AdLefeeAdType)type adLefeeViewDelegate:(id<AdLefeeBannerViewDelegate>)delegate adLefeeBroswerDelegate:(id<AdLefeeBrowserDelegate>)broswerDelegate;
- (void)requestAd;
- (void)pauseloadAd;
- (void)continueloadAd;
- (void)destoryAd;
