...
+ (instancetype)initWithAdid:(NSString *)adid withDelegate:(id<AdLefeeInterstitialDelegate>) delegate withBroswerDelegate:(id<AdLefeeBrowserDelegate>) broswerDelegate;
